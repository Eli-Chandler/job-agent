...
Revision ID: 014a0130fc9e
Revises: 
Create Date: 2025-08-20 03:03:02.308389
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('_application_status', sa.Enum('PENDING', 'APPLYING', 'APPLIED', 'INTERVIEWING', 'REJECTED', 'OFFERED', name='jobapplicationstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['used_cover_letter_id'], ['cover_letter.id'], ),
    sa.ForeignKeyConstraint(['used_resume_id'], ['resume.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('profile_certification',
    sa.Column('id', sa.Integer(), nullable=False),
