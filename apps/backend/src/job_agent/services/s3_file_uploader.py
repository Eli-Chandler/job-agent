...
class S3FileUploader:
    ...
    async def upload(self, file: FileContent, key: Optional[str] = None) -> StoredFile:
        ...
        stored_file = StoredFile(key=key, bucket=self._bucket, content_type=file.content_type)
    ...
    async def generate_presigned_url(self, file: StoredFile, expiration: int = 60) -> PresignedUrlDTO:
