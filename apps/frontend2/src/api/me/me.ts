...
export const getGetCurrentlyAuthenticatedUserQueryOptions = <TData = Awaited<ReturnType<typeof getCurrentlyAuthenticatedUser>>, TError = AxiosError<ErrorModel>>(options?: {
                                                                                                                                                                     query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentlyAuthenticatedUser>>, TError, TData>>,
    ...
    } as UseQueryOptions<Awaited<ReturnType<typeof getCurrentlyAuthenticatedUser>>, TError, TData> & {
...
export function useGetCurrentlyAuthenticatedUser<TData = Awaited<ReturnType<typeof getCurrentlyAuthenticatedUser>>, TError = AxiosError<ErrorModel>>(
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentlyAuthenticatedUser>>, TError, TData>> & Pick<
            DefinedInitialDataOptions<
...
export const getGetResumesQueryOptions = <TData = Awaited<ReturnType<typeof getResumes>>, TError = AxiosError<ErrorModel>>(options?: {
                                                                                                                               query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getResumes>>, TError, TData>>,
                                                                                                                               axios?: AxiosRequestConfig
                                                                                                                           }
) => {
    ...
    return {
        queryKey,
        queryFn, ...queryOptions
    } as UseQueryOptions<Awaited<ReturnType<typeof getResumes>>, TError, TData> & {
        queryKey: DataTag<QueryKey, TData, TError>
    }
}
...
export function useGetResumes<TData = Awaited<ReturnType<typeof getResumes>>, TError = AxiosError<ErrorModel>>(
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getResumes>>, TError, TData>> & Pick<
            DefinedInitialDataOptions<
...
export const getUploadResumeMutationOptions = <TError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>,
    TContext = unknown>(options?: {
                            mutation?: UseMutationOptions<Awaited<ReturnType<typeof uploadResume>>, TError, {
    ...
    const mutationFn: MutationFunction<Awaited<ReturnType<typeof uploadResume>>, {
        data: BodyUploadResume
    }> = (props) => {
        const {data} = props ?? {};
...
export type UploadResumeMutationError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>

/**
 * @summary Upload Resume
 */
export const useUploadResume = <TError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>,
    TContext = unknown>(options?: {
                            mutation?: UseMutationOptions<Awaited<ReturnType<typeof uploadResume>>, TError, {
                                data: BodyUploadResume
                            }, TContext>,
...
export const getDeleteResumeMutationOptions = <TError = AxiosError<ErrorModel | HTTPValidationError>,
    TContext = unknown>(options?: {
                            mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteResume>>, TError, { resumeId: number }, TContext>,
                            axios?: AxiosRequestConfig
                        }
...
export const getGetResumePresignedUrlQueryOptions = <TData = Awaited<ReturnType<typeof getResumePresignedUrl>>, TError = AxiosError<ErrorModel | HTTPValidationError>>(resumeId: number, options?: {
                                                                                                                                                                           query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getResumePresignedUrl>>, TError, TData>>,
                                                                                                                                                                           axios?: AxiosRequestConfig
                                                                                                                                                                       }
) => {
    ...
    return {
        queryKey,
        queryFn,
        enabled: !!(resumeId), ...queryOptions
    } as UseQueryOptions<Awaited<ReturnType<typeof getResumePresignedUrl>>, TError, TData> & {
        queryKey: DataTag<QueryKey, TData, TError>
    }
}
...
export function useGetResumePresignedUrl<TData = Awaited<ReturnType<typeof getResumePresignedUrl>>, TError = AxiosError<ErrorModel | HTTPValidationError>>(
    resumeId: number, options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getResumePresignedUrl>>, TError, TData>> & Pick<
            DefinedInitialDataOptions<
