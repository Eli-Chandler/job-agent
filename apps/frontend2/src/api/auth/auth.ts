...
export const getLoginAuthTokenPostMutationOptions = <TError = AxiosError<null | HTTPValidationError>,
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LoginAuthTokenPostMutationError = AxiosError<null | HTTPValidationError>

    /**
 * @summary Login
 */
export const useLoginAuthTokenPost = <TError = AxiosError<null | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginAuthTokenPost>>, TError,{data: BodyLoginAuthTokenPost}, TContext>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient): UseMutationResult<
