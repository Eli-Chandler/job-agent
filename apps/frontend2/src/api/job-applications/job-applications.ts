...
export const getApplyJobJobApplicationsPostMutationOptions = <TError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>,
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ApplyJobJobApplicationsPostMutationError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>

    /**
 * @summary Apply Job
 */
export const useApplyJobJobApplicationsPost = <TError = AxiosError<ErrorModel | ErrorModel | HTTPValidationError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof applyJobJobApplicationsPost>>, TError,{data: CreateJobApplicationRequest}, TContext>, axios?: AxiosRequestConfig}
